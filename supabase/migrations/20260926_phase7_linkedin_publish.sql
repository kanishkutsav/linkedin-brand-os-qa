...
ALTER TABLE approval_requests
    ADD COLUMN IF NOT EXISTS published_image_urn VARCHAR(255);
...
-- OAuth state and one-time exchange records are short-lived. This index
-- supports inexpensive cleanup by the scheduled maintenance path if needed.
